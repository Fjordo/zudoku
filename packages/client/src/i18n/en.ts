...
export const en = {
  ...
  'game.keyboardHelp': 'Keyboard: 1-9 to fill, N for notes, H for a hint, arrows to move, backspace to erase.',
  'game.solved': 'Solved!',
  ...
  'hint.wrong': '{cell} cannot hold {digit}. Erase it before going on.',
  ...
  'techniques.rules': [
    ...
    'In this app three wrong digits end the run, so prefer a deduction you can justify over a guess.',
  ],
  'level.basic': 'Basic',
